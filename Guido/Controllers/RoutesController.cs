...
namespace Guido.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var route = db.Route.Include(c => c.ID);
        ...
        public ActionResult Create([Bind(Include = "ID,typOfRoute,routeTime")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,typOfRoute,routeTime")] Route route)
        {
            if (ModelState.IsValid)
            {
